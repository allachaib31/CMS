...
import { addCommentCommodityRevenueFetch } from '../../utils/apiFetch';

function AddNoteGoodsRevenueRecord({ inputs, setInputs }) {
    const navigate = useNavigate();
    const [submit, setSubmit] = useState(false);
    const handleSubmit = () => {
        setSubmit((e) => !e);
        addCommentCommodityRevenueFetch(inputs).then((res) => {
            setSubmit((e) => !e);
...
export default AddNoteGoodsRevenueRecord