            ...
            <div className="overflow-x-auto mt-[1rem]">
                <table className="text-[1rem] table border-separate border-spacing-2 border w-[2000px] mx-auto">
                    <tr className='text-center'>
                        <th className="border text-center border-slate-600" colSpan={12}>بيانات المساهمة</th>
                    </tr>
                    <tr>
                        ...
                        <th className="border text-center border-slate-600" colSpan={2} rowSpan={2}>
                    ...
                    <tr>
                        ...
                        <th className="border text-center border-slate-600" rowSpan={2}>
                            التكلفة الكلية حاليا
                        </th>
                        <th className="border text-center border-slate-600" rowSpan={2}>
                            الربــــح الخسارة
                        </th>
                        <th className="border text-center border-slate-600" rowSpan={2}>
                            نسبة: الربـــــح الخسـارة
                        </th>
                        <th className="border text-center border-slate-600" rowSpan={2}>
                            إجمالي تكلفة الشراء
                        </th>
                    ...
                    <tr className='text-center'>
                        <th className="border border-slate-600" colSpan={12}>بيانات العضو المساهم باسم الصندوق </th>
                    </tr>
                    <tr>
                        <th className="border text-center border-slate-600" colSpan={4}>اسم العضو</th>
                        <th className="border text-center border-slate-600" colSpan={4}>نسبته من الربح </th>
                        <th className="border text-center border-slate-600" colSpan={4}>مبلغ نسبته من الربح</th>
                    </tr>
                    <tbody>
                        <tr>
                        <td className="border text-center border-slate-600" colSpan={4}></td>
                            <td className="border text-center border-slate-600" colSpan={4}></td>
                            <td className="border text-center border-slate-600" colSpan={4}></td>
                        </tr>
                    </tbody>
                    <tr className='text-center'>
                        <th className="border border-slate-600" colSpan={12}>بيانات الصندوق</th>
                    </tr>
                    <tr>
                        ...
                        <th className="border text-center border-slate-600" colSpan={2}>نسبة: الربح / الخسارة</th>
                    ...
                    <tr className='text-center'>
                        <th className="border border-slate-600" colSpan={12}>بيانات المساهمين</th>
                    </tr>
                    <tr>
