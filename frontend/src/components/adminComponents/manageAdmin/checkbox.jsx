...
function Checkbox({inputs, setInputs}) {
    ...
    return (
        <div>
            <label className="text-[1.1rem]">الصلاحيات</label>
            <div>
                <div className="flex-row form-control">
                    <label className="label gap-[1rem] cursor-pointer">
                        ...
                        <span className="label-text">الكل</span>
                    </label>
                </div>
                <div className="flex flex-wrap">
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">إضافة بيانات الأعضاء الجدد أو الحذف أو التعديل</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">إضافة أو حذف أو تعديل مسؤول جديد</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">تفعيل و إيقاف إشتراك عضو</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                    ...
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">إضافة بيانات المساهمات في الأسهم</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                    ...
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">إضافة إيرادات (اشتراكات الأعضاء)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                    ...
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة إيرادات عضو (كلي أو جزئي حسب المدة) </span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة الإيرادات (كلي أو جزئي حسب المدة)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة سجل الاشتراكات (سنوي ، شهري ، أو مدة محددة)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة مصروفات عضو (كلي أو جزئي حسب المدة)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة القروض و أقساطها (كل الأعضاء أو عضو محدد)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة سجل المساهمة في شراء السلع</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة طلب شراء سلعة (بعد التعبئة)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            <input type="checkbox" value="طباعة سجل المساهمة في الأسهم" onChange={handleCheckboxChange} className="checkbox checkbox-primary" />
                            <span className="label-text">طباعة سجل المساهمة في الأسهم</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة عقد شراء سلعة و أقساطها (بعد التعبئة)</span>
                        </label>
                    </div>
                    <div className="w-full sm:w-1/2 flex-row form-control">
                        <label className="label gap-[1rem] cursor-pointer">
                            ...
                            <span className="label-text">طباعة المصروفات   (كلي أو جزئي حسب المدة)</span>
                        </label>
                    </div>
                </div>
            </div>
