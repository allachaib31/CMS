...
import { addTypeExpensesFetch, deleteTypeExpensesFetch, getTypeExpensesFetch } from '../../../utils/apiFetch';
...
function AddReimbursedExprensesType() {
  ...
  const handleDelete = (input, index) => {
    ...
    deleteTypeExpensesFetch(input).then((res) => {
      setShowAlert({
        display: true,
        status: true,
        text: res.data.msg
  ...
  const handleSubmit = () => {
    ...
    setSubmit((e) => !e);
    addTypeExpensesFetch(inputs).then((res) => {
      setSubmit((e) => !e);
      setShowAlert({
        display: true,
        status: true,
