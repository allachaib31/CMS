...
function CompetitionBranches() {
    ...
    return (
        <div className="container mx-auto sm:p-0 px-[1rem]">
            <Link to={"/manageContest/competitionBranches/addQuestion?idContest=" + queryParams.get("idContest") + "&idBranche=" + queryParams.get("idBranche")} className='btn btn-primary font-bold text-white'>إضافة سؤال</Link>
