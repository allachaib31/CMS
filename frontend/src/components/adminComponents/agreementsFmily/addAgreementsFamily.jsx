...
import { addAgreementsFamilyFetch } from '../../../utils/apiFetch';
...
function AddAgreementsFamily() {
    ...
    return (
        <div className="sm:p-0 px-[1rem] container mx-auto">
            <div>
                <LRouter to="/agreementsFamily" className="btn btn-primary text-[2rem] px-[2rem]">
...
export default AddAgreementsFamily;
