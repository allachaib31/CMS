...
function AddUser() {
    ...
    return (
        <div className="container mx-auto sm:p-0 px-[1rem]">
            <div>
                <Link to="/user" className="btn btn-sm btn-primary px-[2rem]">
                    <FontAwesomeIcon icon={faRightLong} />
                </Link>
            </div>
            <h1 className="text-center text-[1.1rem] font-bold py-[0.5rem]">
                إضافة عضو جديد
            </h1>
            <form action="" className="flex flex-col gap-[1rem]">
                ...
                <div className="flex sm:flex-row flex-col gap-[1rem]">
                    <div className="relative sm:w-1/2">
                        ...
                        }} required className="formInput w-full input input-sm pr-[2.3rem] input-bordered flex items-center gap-2" placeholder={`اسم`} pattern="^.{3,1024}$" />
                    </div>
                    <div className="relative sm:w-1/2">
                        ...
                        }} required className="formInput w-full input input-sm pr-[2.3rem] input-bordered flex items-center gap-2" placeholder="رقم الهوية الوطنية" pattern="[1-9]\d{9}" />
                    </div>
                </div>
                <div className="flex sm:flex-row flex-col gap-[1rem]">
                    <div className="relative sm:w-1/2">
                        ...
                        }} required className="formInput w-full input input-sm pr-[2.3rem] input-bordered flex items-center gap-2" placeholder="رقم الجوال" pattern="05\d{8}" />
                    </div>
                    <div className="relative sm:w-1/2">
                ...
                <button
                    ...
                    onClick={(event) => {
                        ...
                        handleSubmit();
                    }} className="btn btn-sm text-white font-bold btn-primary">{submit ? <span className="loading loading-ring loading-lg"></span> : "تاكيد"}</button>
            </form>
        </div>
    );
}
