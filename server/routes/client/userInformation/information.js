...
const { getClientInformation, getAgreements, getElection, setVote, ElectionDetails, getAdvertising, getSubscribeClient} = require("../../../controllers/client/userInformation/information");
...
Router.get("/api/v1.0/clientInformation/subscribe", authMiddleware, getSubscribeClient);
//POST METHODS
